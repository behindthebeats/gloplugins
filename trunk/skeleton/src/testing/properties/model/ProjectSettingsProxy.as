...
package testing.properties.model
{
	...
	import testing.properties.data.ProjectSettingsVO;
	
	//import testing.properties.data.PageInstanceVO;
	...
	public class ProjectSettingsProxy extends Proxy
	{
		...
		public function set testPlugin(plugin:IComponentPlugin):void
		{
			_plugin = plugin;
		}
		/**
