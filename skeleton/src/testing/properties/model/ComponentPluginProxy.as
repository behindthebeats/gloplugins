...
package testing.properties.model
{
	import testing.properties.data.ComponentVO;
	import testing.properties.data.PluginInfoVO;
	import testing.properties.data.PluginType;
	...
	public class ComponentPluginProxy extends PluginProxy
	{
		...
		override protected function getPluginPath():String
		{
		...
		override protected function doCustomProcessing(vo:PluginInfoVO, infoFile:String, rawXML:XML):PluginInfoVO
		{
