...
package testing.properties
{
	...
	import testing.properties.controls.CheckBoxControl;
	import testing.properties.controls.ColourSelectorControl;
	import testing.properties.controls.FilePathControl;
	import testing.properties.controls.IPropertyControl;
	import testing.properties.controls.IntegerControl;
	import testing.properties.controls.NumericStepperControl;
	...
	public class HorzPropertiesPanelCode extends HBox
	{
		 ...
		 * @param figure
		 */		
		protected function initialiseDimensionProperties(figure:IComponentPlugin):void
		{
